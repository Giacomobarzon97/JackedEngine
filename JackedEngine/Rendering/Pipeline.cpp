	...
	swapChain(swapChain)
{
	...
	VkPipelineVertexInputStateCreateInfo vertexInputInfo = getVertexInputCreateInfo();
	...
	VkPipelineRasterizationStateCreateInfo rasterizer = getRasterizationCreateInfo();
	VkPipelineMultisampleStateCreateInfo multisampling = getMultisampleCreateInfo();
...
VkPipelineVertexInputStateCreateInfo Pipeline::getVertexInputCreateInfo() {
...
VkPipelineRasterizationStateCreateInfo Pipeline::getRasterizationCreateInfo() {
...
VkPipelineMultisampleStateCreateInfo Pipeline::getMultisampleCreateInfo() {
