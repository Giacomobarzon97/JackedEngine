...
void BaseAllocator::TransitionImageLayout(const VkImage& image, const VkFormat& format, const VkImageLayout& oldLayout, const VkImageLayout& newLayout, const uint32_t layerCount) const {
	VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
void BaseAllocator::CopyBufferToImage(const VkBuffer& buffer, const VkImage& image, const uint32_t width, const uint32_t height, const uint32_t layerCount) const {
	VkCommandBuffer commandBuffer = beginSingleTimeCommands();
